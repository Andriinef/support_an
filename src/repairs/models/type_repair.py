...
class TypeRepair(models.Model):
    ...
    type_works = models.ManyToManyField(
        to="repairs.Works", verbose_name="Роботи", related_name="work_repairs"
    )
    price = models.FloatField(
        "Вартість послуги", null=True, default=0.00, help_text="грн."
    )
    guarantee = models.PositiveSmallIntegerField(
        "Гарантія на послугу", null=True, default=1, help_text="місяч"
    )
